...
namespace STIDNR._1_2
{
    public partial class Form13 : Form
    {
        ...
        private void DisplayData()
        {
            ...
            adapt = new SqlDataAdapter("select * from Parteneri", conectare);
            adapt.Fill(dt);
        ...
        {
            conectare.Open();
            SqlDataAdapter sqlAdap = new SqlDataAdapter("Select * From Parteneri", conectare);
        ...
        {
            conectare.Open();
            SqlDataAdapter sda = new SqlDataAdapter("insert into Parteneri(IdParteneriat,NumeParteneriat,DataParteneriat) values('" + textBox1.Text + "', '" + textBox2.Text+ "', '" + textBox3.Text   + "')", conectare);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "Delete from Parteneri where IdParteneriat= '" + textBox1.Text + "'";
