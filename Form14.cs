...
namespace STIDNR._1_2
{
    public partial class Form14 : Form
    {
        ...
        {
            conectare.Open();
            SqlDataAdapter sqlAdap = new SqlDataAdapter("Select * From Clientiii", conectare);
        ...
        private void DisplayData()
        {
            ...
            adapt = new SqlDataAdapter("select * from Clientiii", conectare);
            adapt.Fill(dt);
        ...
        {
            conectare.Open();
            SqlDataAdapter sda = new SqlDataAdapter("insert into Clientiii(IdClient,NumeClient,TelefonClient,EmailClient) values('" + textBox1.Text + "', '" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')", conectare);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "Delete from Clientiii where IdClient= '" + textBox1.Text + "'";
